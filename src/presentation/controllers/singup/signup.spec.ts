...
describe('SingUp Controller', () => {
  ...
  test('Schould call EmailValidator with corrent email', () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Schould return 500 if EmailValidtor throws', () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Schould call AddAccount with corrent values', () => {
  ...
  test('Schould return 500 if AddAccount throws', () => {
    const { sut, addAccountStub } = makeSut()
  ...
  test('Schould return 200 if valid data is provided', () => {
    const { sut } = makeSut()
